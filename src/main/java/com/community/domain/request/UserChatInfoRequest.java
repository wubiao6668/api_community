...
@Data
public class UserChatInfoRequest extends UserChatInfoDO implements PageAble, Serializable {
    private static final long serialVersionUID = 3148176768559230877L;

    /**
     * 最后发送时间
     */
    private LocalDateTime lastSendTimeBegin;
    private LocalDateTime lastSendTimeEnd;
    /**
     * createTime
     */
