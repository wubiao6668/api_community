...
@Data
public class GroupMemberRequest extends GroupMemberDO implements PageAble, Serializable {
     ...
     * 禁言过期时间
     */
    private LocalDateTime interdictionExpiryTimeBegin;
    private LocalDateTime interdictionExpiryTimeEnd;
    /**
     * createTime
     */
